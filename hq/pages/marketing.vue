<template>
  ...
  <section
    ...
    <div class="container mx-auto pt-[40vw] text-center sm:pt-[30vw] lg:pt-[20vw]">
      <h1 class="mx-auto max-w-lg text-5xl leading-[1.2] text-white sm:text-6xl lg:max-w-2xl" data-reveal>
        {{ pageData.hero.headline }}
      </h1>
      <div class="relative z-10 mx-auto mt-16 aspect-video" data-reveal>
        <iframe width="560" height="315" class="absolute left-0 h-full w-full"
          :src="`https://www.youtube.com/embed/${pageData.hero.videoId}`" title="YouTube video player" frameborder="0"
  ...
  <section class="home-stats px-row py-row2x">
    <div class="container mx-auto flex flex-col items-center gap-16 text-center lg:flex-row lg:items-start lg:gap-24">
    ...
    <div class="container mx-auto" data-reveal>
      <div
        ...
        <h2 class="text-gray-dark mb-5 text-center uppercase tracking-wider">
          <span class="font-script text-accent text-4xl normal-case">The</span><br />
          Home<br />
          Buyer's<br />
          Guide
        </h2>
  ...
  <section class="px-row py-row">
    <div class="container mx-auto">
      <span class="text-gray-light text-xs uppercase tracking-[0.35em]" data-reveal>Why Us?</span>
      <h2 class="mb-12 mt-4 max-w-4xl text-5xl leading-[1.2] sm:text-6xl" data-reveal>
        {{ pageData.whyUs.headline }}
      </h2>
      <div v-for="bullet in pageData.whyUs.bullets" class="mt-8" data-reveal>
        <div class="mb-4 flex items-start">
          <Icon :name="bullet.icon.toLowerCase().replace(' ', '_')" color="secondary" size="20" filled class="mr-4" />
          <div>
