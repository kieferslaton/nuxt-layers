<template>
  ...
  <section class="flex flex-col items-center">
    ...
    <nuxt-img src="/images/homebuyers-hero.png" class="mb-8" width="648" />
    <div
      class="content mb-12 px-row lg:max-w-[800px] lg:px-0"
      v-html="content"
    />
    <Accordion
      :items="steps"
      ...
      headerClasses="px-row tl:px-0 py-5"
      contentClasses="px-row tl:px-0"
      classes="mb-12 tl:mx-auto tl:max-w-[800px]"
    />
    <div
      class="mb-24 flex flex-col justify-between gap-8 lg:w-[800px] lg:flex-row-reverse"
    >
      <a
        :href="`/homebuyers-guide/${
          title === 'Buying' ? 'construction' : 'after-purchase'
        }`"
        class="btn btn-secondary btn-full self-start"
      ...
      <a
        href="/homebuyers-guide"
        class="btn-gray-light-transparent btn flex items-center justify-start self-start pl-2"
        ><Icon
          name="chevron_left"
          color="secondary"
          size="16"
