    ...
    <div class="home-card-details">
      <div class="mb-3 flex w-full items-center">
        ...
        <svg
          ...
          width="56"
          height="23.848"
          viewBox="0 0 56 23.848"
          class="stroke-secondary"
        >
          <g
            id="Group_959"
            data-name="Group 959"
            transform="translate(-339.569 -612.937)"
          >
            <path
              id="Path_252"
              data-name="Path 252"
              d="M348.569,1674.861h54s-7.612-6.8-7.492-10.9"
            ...
            <path
              id="Path_253"
              data-name="Path 253"
              d="M348.569,1663.966h54s-7.612,6.8-7.492,10.9"
              transform="translate(-8 -1039.105)"
              fill="none"
              stroke-linecap="round"
              stroke-linejoin="round"
              stroke-width="2"
